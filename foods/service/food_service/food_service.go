...
type foodServiceInterface interface {
	...
	GetAllFoods() ([]*food_domain.Food, error_utils.MessageErr)
}
...
func (f *foodService) GetAllFoods() ([]*food_domain.Food, error_utils.MessageErr) {
	foods, err := food_domain.FoodRepo.GetAllFoods()
