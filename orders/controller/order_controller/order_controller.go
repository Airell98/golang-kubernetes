...
import (
	...
	"golang-kubernetes/orders/events/orders_producer"
	"golang-kubernetes/orders/service/food_service"
...
func PayOrders(c *gin.Context) {
	...
	for _, order := range orderReq {
		...
		orderData, err := order_service.OrderService.GetOrderById(order.Id)
...
func UpdateOrderAmount(c *gin.Context) {
	...
	order, err := order_service.OrderService.UpdateOrderAmount(&orderReq)
...
func GetOrdersByUserId(c *gin.Context) {
	...
	orders, err := order_service.OrderService.GetOrdersByUserId(userId)
